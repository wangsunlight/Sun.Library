...
namespace Sun.Core.Extensions
{
    ...
    public static partial class Extensions
    {
        ...
        /// <returns></returns>
        public static long GetTimestampSeconds(this TimeSpan timespan)
        {
            return new DateTimeOffset(DateTime.Now.Add(timespan)).UtcDateTime.Ticks / 10_000_000L - 62135596800L;
        }
        ...
        {
            return new DateTimeOffset(dateTime).UtcDateTime.Ticks / 10_000_000L - 62135596800L;
        }
        ...
        /// <returns></returns>
        public static DateTime GetDataTime(this long time)
        {
            DateTime nowTime;
            int timeLength = time.ToString().Length;
            if (timeLength == 13)
            {
                nowTime = new DateTime(1970, 1, 1, 8, 0, 0).AddMilliseconds(time);
            }
            else if (timeLength == 10)
            {
                nowTime = new DateTime(1970, 1, 1, 8, 0, 0).AddSeconds(time);
            }
            else
            {
                return default;
        ...
        /// <param name="timespan"></param>
        /// <returns></returns>
        public static long GetTimestampMilliseconds(this TimeSpan timespan)
        {
            return new DateTimeOffset(DateTime.Now.Add(timespan)).UtcDateTime.Ticks / 10000L - 62135596800000L;
        }
        ...
        {
            return new DateTimeOffset(dateTime).UtcDateTime.Ticks / 10000L - 62135596800000L;
        }
