...
namespace Sun.Core.Helper
{
    ...
    public static class ReflectionHelper
    {
        ...
        /// <summary>
        /// 获取有效的类型集合，排除SkipScanAttribute
        /// </summary>
        /// <returns></returns>
        //public static IEnumerable<Type> EffectiveTypes()
        //{
        //    return Load().SelectMany(u => u.GetTypes()
        ...
        public static List<Assembly> Load()
        {
            var list = DependencyContext.Default.CompileLibraries
                .Where(u =>
                       (u.Type == "project" && u.Name != "YH.WechatSDK" && u.Name != "nacos-sdk-csharp") ||
                       (u.Type == "package" && (u.Name.StartsWith("YH.ServicePlatform") || u.Name.StartsWith("YH.NetMicro"))))
        ...
        /// 程序集是否匹配
        /// </summary>
        private static bool Match(Assembly assembly)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<Assembly> Load(Func<CompilationLibrary, bool> predicate)
        {
            var list = DependencyContext.Default.CompileLibraries.Where(predicate).ToList();
        ...
        public static List<Item> GetPublicProperties(object instance)
        {
            ...
            return properties.Select(t => new Item(t.Name, t.GetValue(instance))).ToList();
        }
